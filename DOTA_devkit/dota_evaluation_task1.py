...
def parse_args():
    ...
    parser.add_argument('--detpath', default='/data2/tiancai/code_augment/RepDETR_Aug_4points/logs/inference_29/result_merge/Task1_{:s}.txt', help='test config file path')
    parser.add_argument('--annopath', default='/data2/tiancai/datasets/DOTAV1_0/val/labelTxt/{:s}.txt', help='checkpoint file')
    parser.add_argument('--imagesetfile', default="/data2/tiancai/code_new_model/RepDETR/imgnamefilev1_0.txt", help='checkpoint file')
